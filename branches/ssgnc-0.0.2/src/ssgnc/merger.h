#ifndef SSGNC_MERGER_H
#define SSGNC_MERGER_H
...
{
public:
	explicit Merger(std::ostream *output)
	...
	// Inserts a pair of a key ID and an address.
	bool Insert(const char *line)
	{
		if (finished_)
			return false;
