// This program builds an inverted database.

#include "ssgnc/db-divider.h"
#include "ssgnc/db-merger.h"
#include "ssgnc/tempfile-manager.h"
#include "ssgnc/timer.h"
#include "ssgnc/byte-writer.h"
...
int main(int argc, char *argv[])
{
	...
	// Builds inverted databases.
	ssgnc::TempfileManager tempfile_manager(temp_dir);
	ssgnc::DbDivider divider;
